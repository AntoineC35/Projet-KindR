...
export const createConversation = (data) => {
  return (dispatch) => {
    return axios.post(apiUrl + "create_conversation", data).then((res) => {
...
export const getConversation = (data) => {
  return (dispatch) => {
    return axios.post(apiUrl + "get_conversation", data).then((res) => {
...
export const getAllConversations = (data) => {
  return (dispatch) => {
    return axios.post(apiUrl + "get_all_conversations", data).then((res) => {
...
export const createMessage = (data) => {
  return (dispatch) => {
    return axios.post(apiUrl + "create_message", data).then((res) => {
...
export const getMessage = (data) => {
  return (dispatch) => {
    return axios.post(apiUrl + "get_message/" + data).then((res) => {
...
export const startConversation = (data) => {
  return (dispatch) => {
    return axios.post(apiUrl + "start_conversation", data).then((res) => {
